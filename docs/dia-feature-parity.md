...
| Selected/hover/pressed row styling + selected glow | ✓ | ✅ | Dia 1.50 selected tint (#121212 at 0.5 dark, white 0.7 light). Compared with a Dia 1.50.1 capture (dark, 1×, 2026-09-26) and its binary: tiles and rows sit in TabList's symmetric 6 pt inset (`0x105391ac4`; was 7), so they span x 6 … 184 at 190; the favicon is 9 pt into the row, and it no longer moves 1 pt right when a row is selected (the selection border took layout room); the New Tab icon is Dia's mark (a dome with a concave bottom, 16 pt wide, white 0.28 in dark), matching the capture's shape and colour within a level. Fill #121212 at 0.5 within 2 levels. Left: the Dia capture's rows end about 1 pt further right (x 185), with its card edge 0.5 pt further too; light mode not compared (checklist step 10). Loading spinner in rows: Dia's `ActivitySpinnerView` (12 pt, 8 pt from the row's end, track + 72 % arc 1.5 pt wide in secondaryLabelColor, 1.88 s per turn), hidden under the hover close button |
